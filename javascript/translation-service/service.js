...
export class TranslationService {
   ...
   */
  free(text) {
    // let res = this.api.fetch(text);
    // return new Promise(function (resolve, reject) {
    //   res
    //     .then((value) => resolve(value.translation))
  ...
  batch(texts) {
    ...
    // }
    // let promises = texts.map((value) => this.api.fetch(value))
    // return Promise.all(promises).
    //   then((results) => Promise.resolve(results.map((result) => result.translation))).
